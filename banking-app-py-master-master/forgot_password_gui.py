...
class ForgotPasswordGUI:
    ...
    def send_new_password(self):
        ...
        with SessionLocal() as session:
            try:
                # Query the user within the same session
                ...
                # Update the user's password in the same session
                ...
                messagebox.showinfo("Success", "A new password has been sent to your email address. Use it to log in.")
