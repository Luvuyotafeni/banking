...
class RegistrationApp:
    def __init__(self, master):
        ...
        self.label_phone_number.pack(pady=5)
        ...
        self.checkbox_generate_password.pack(pady=5)
    ...
    def validate_phone_number(self, event):
        ...
        if not (phone_number.isdigit() and len(phone_number) == 10):
            ...
            # If phone number is valid, proceed to email validation
    ...
    def validate_email(self, event):
        ...
        if not re.match(r"[^@]+@[^@]+\.[^@]+", email):
            ...
            # If email is valid, proceed to password validation
